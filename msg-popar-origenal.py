...
destination_chat_id = -4554789043  # Replace this with the destination group/channel chat ID
...
def extract_and_prepend(message):
    try:
        ...
        buy_keywords = ["BUY BANKNIFTY", "BUY NIFTY", "BUY FINNIFTY", "BUY MIDCPNIFTY"]
        
        # Find the keyword that appears in the message
        buy_index = -1
        ...
        # Extract the part between the matched "BUY ..." keyword and "ABOVE"
        above_index = message_upper.find("ABOVE")
        extracted_text = message[buy_index:above_index].strip()
        ...
        # Extract Option type
        option_type = first_line.split()[1]
        share_qty = 0
